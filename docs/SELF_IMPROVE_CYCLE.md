...
_Generated 2026-07-15 19:40 UTC_
...
### Success criteria
- [x] PR is reviewable in &lt; ~300 LOC of core logic (+ tests) — `src/nexus/improve_apply.py`  
- [x] Re-running the demo does not corrupt state (idempotent)  
- [x] Audit cites only EVIDENCE-backed repo/paper ids  
...
**Landed:** `nexus demo self-improve-slice --show-audit` · MCP `apply_phase` · see `docs/LATEST_IMPROVE_PLAN.md`.
