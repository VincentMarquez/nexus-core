...
| **Alive / mine self-improve** | [assets/arch-alive-self-improve.svg](assets/arch-alive-self-improve.svg) | User goal → token budget → mine/score → improve ours → optional self-approve |
